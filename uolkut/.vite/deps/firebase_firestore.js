...
var C2 = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";
...
async function __PRIVATE_ignoreIfPrimaryLeaseLoss(e) {
  if (e.code !== D2.FAILED_PRECONDITION || e.message !== C2)
    throw e;
...
var __PRIVATE_IndexedDbIndexManager = class {
  ...
  An(e, t) {
    ...
    for (const r2 of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      ...
      __PRIVATE_FirestoreIndexValueWriter.vt.Tt(e2, i);
    }
    return n.zt();
  }
  ...
  Tn(e) {
    ...
    return __PRIVATE_FirestoreIndexValueWriter.vt.Tt(e, t.Yt(
      0
      /* IndexKind.ASCENDING */
    )), t.zt();
  }
  ...
  Rn(e, t) {
    const n = new __PRIVATE_IndexByteEncoder();
    return __PRIVATE_FirestoreIndexValueWriter.vt.Tt(__PRIVATE_refValue(this.databaseId, t), n.Yt(function __PRIVATE_fieldIndexGetKeyOrder(e2) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      ...
      for (const n2 of r2)
        if (this.Vn(t, s.fieldPath) && isArray(e2))
          ...
          __PRIVATE_FirestoreIndexValueWriter.vt.Tt(e2, t2);
        }
    }
    return this.fn(r2);
  }
  ...
  mn(e, t, n) {
    ...
    for (const e2 of n.arrayValue.values || [])
      for (const n2 of r2) {
        ...
        r3.seed(n2.zt()), __PRIVATE_FirestoreIndexValueWriter.vt.Tt(e2, r3.Yt(t.kind)), i.push(r3);
      }
    return i;
  }
  Vn(e, t) {
...
var __PRIVATE_SchemaConverter = class {
  ...
  si(e, t) {
    const n = t.store("mutations"), r2 = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer), i = new __PRIVATE_MemoryPersistence(__PRIVATE_MemoryEagerDelegate.Hr, this.serializer.ht);
    return n.G().next((e2) => {
      const n2 = /* @__PURE__ */ new Map();
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r2, i, s, o, _, a, u, c = 15) {
    ...
    this.Ii = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.v())
  ...
  pi(e) {
    ...
    return __PRIVATE_primaryClientStore(e).get("owner").next((t) => {
      ...
      return !(!this.networkEnabled || !this.inForeground) || __PRIVATE_clientMetadataStore(e).G().next((e2) => void 0 === this.Ci(e2, 5e3).find((e3) => {
   ...
   */
  Ci(e, t) {
    return e.filter((e2) => this.vi(e2.updateTimeMs, t) && !this.Mi(e2.clientId));
  }
  /**
   ...
   */
  Li() {
    return this.runTransaction("getActiveClients", "readonly", (e) => __PRIVATE_clientMetadataStore(e).G().next((e2) => this.Ci(e2, 18e5).map((e3) => e3.clientId)));
  }
  get started() {
    return this.qr;
  }
  ...
  runTransaction(e, t, n) {
    ...
    return this.Ei.runTransaction(e, r2, i, (r3) => (s = new __PRIVATE_IndexedDbTransaction(r3, this.kr ? this.kr.next() : __PRIVATE_ListenSequence.ae), "readwrite-primary" === t ? this.gi(s).next((e2) => !!e2 || this.pi(s)).next((t2) => {
      if (!t2)
        throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = false, this.oi.enqueueRetryable(() => this.Ii(false)), new FirestoreError(D2.FAILED_PRECONDITION, C2);
      return n(s);
  ...
  ki(e) {
    return __PRIVATE_primaryClientStore(e).get("owner").next((e2) => {
      if (null !== e2 && this.vi(e2.leaseTimestampMs, 5e3) && !this.Mi(e2.ownerId) && !this.Si(e2) && !(this.ai || this.allowTabSynchronization && e2.allowTabSynchronization))
        throw new FirestoreError(D2.FAILED_PRECONDITION, de);
    });
  }
  /**
...
var __PRIVATE_QueryEngine = class {
  ...
  initialize(e, t) {
    this.Ui = e, this.indexManager = t, this.$i = true;
  }
  /** Returns all local documents matching the specified query. */
  getDocumentsMatchingQuery(e, t, n, r2) {
    return this.Wi(e, t).next((i) => i || this.Gi(e, t, r2, n)).next((n2) => n2 || this.zi(e, t));
  }
  /**
  ...
  Wi(e, t) {
    ...
    (t = __PRIVATE_queryWithLimit(
      ...
      return this.Ui.getDocuments(e, i).next((r4) => this.indexManager.getMinOffset(e, n).next((n2) => {
        const s = this.ji(t, r4);
        return this.Hi(t, s, i, n2.readTime) ? this.Wi(e, __PRIVATE_queryWithLimit(
          t,
          null,
          "F"
          /* LimitType.First */
   ...
   */
  Gi(e, t, n, r2) {
    return __PRIVATE_queryMatchesAllDocuments(t) || r2.isEqual(SnapshotVersion.min()) ? this.zi(e, t) : this.Ui.getDocuments(e, n).next((i) => {
      const s = this.ji(t, i);
      return this.Hi(t, s, n, r2) ? this.zi(e, t) : (__PRIVATE_getLogLevel() <= LogLevel.DEBUG && __PRIVATE_logDebug("QueryEngine", "Re-using previous result from %s to execute query: %s", r2.toString(), __PRIVATE_stringifyQuery(t)), this.Ji(e, s, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(r2, -1)));
    });
  }
  ...
  zi(e, t) {
    return __PRIVATE_getLogLevel() <= LogLevel.DEBUG && __PRIVATE_logDebug("QueryEngine", "Using full collection scan to execute query:", __PRIVATE_stringifyQuery(t)), this.Ui.getDocumentsMatchingQuery(e, t, IndexOffset.min());
  }
  /**
   ...
   */
  Ji(e, t, n, r2) {
    return this.Ui.getDocumentsMatchingQuery(e, n, r2).next((e2) => (
...
var __PRIVATE_LocalStoreImpl = class {
  constructor(e, t, n, r2) {
    this.persistence = e, this.Yi = t, this.serializer = r2, /**
     * Maps a targetID to data about its target.
     *
     * PORTING NOTE: We are using an immutable data structure on Web to make re-runs
     * of `applyRemoteEvent()` idempotent.
     */
    this.Zi = new SortedMap(__PRIVATE_primitiveComparator), /** Maps a target to its targetID. */
    // TODO(wuandy): Evaluate if TargetId can be part of Target.
    this.Xi = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), __PRIVATE_targetEquals), /**
     * A per collection group index of the last read time processed by
     * `getNewDocumentChanges()`.
     *
     * PORTING NOTE: This is only used for multi-tab synchronization.
     */
    this.es = /* @__PURE__ */ new Map(), this.ts = e.getRemoteDocumentCache(), this.Qr = e.getTargetCache(), this.$r = e.getBundleCache(), this.ns(n);
  }
  ns(e) {
    this.documentOverlayCache = this.persistence.getDocumentOverlayCache(e), this.indexManager = this.persistence.getIndexManager(e), this.mutationQueue = this.persistence.getMutationQueue(e, this.indexManager), this.localDocuments = new LocalDocumentsView(this.ts, this.mutationQueue, this.documentOverlayCache, this.indexManager), this.ts.setIndexManager(this.indexManager), this.Yi.initialize(this.localDocuments, this.indexManager);
  }
  collectGarbage(e) {
...
async function __PRIVATE_localStoreHandleUserChange(e, t) {
  ...
  return await n.persistence.runTransaction("Handle user change", "readonly", (e2) => {
    let r2;
    return n.mutationQueue.getAllMutationBatches(e2).next((i) => (r2 = i, n.ns(t), n.mutationQueue.getAllMutationBatches(e2))).next((t2) => {
      const i = [], s = [];
...
function __PRIVATE_localStoreAcknowledgeBatch(e, t) {
  ...
  return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (e2) => {
    const r2 = t.batch.keys(), i = n.ts.newChangeBuffer({
      trackRemovals: true
    });
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
  ...
  return n.persistence.runTransaction("Allocate target", "readwrite", (e2) => {
    ...
    const r2 = n.Zi.get(e2.targetId);
    return (null === r2 || e2.snapshotVersion.compareTo(r2.snapshotVersion) > 0) && (n.Zi = n.Zi.insert(e2.targetId, e2), n.Xi.set(t, e2.targetId)), e2;
  });
}
async function __PRIVATE_localStoreReleaseTarget(e, t, n) {
  const r2 = __PRIVATE_debugCast(e), i = r2.Zi.get(t), s = n ? "readwrite" : "readwrite-primary";
  try {
  ...
  r2.Zi = r2.Zi.remove(t), r2.Xi.delete(i.target);
}
function __PRIVATE_localStoreExecuteQuery(e, t, n) {
  ...
  return r2.persistence.runTransaction("Execute query", "readonly", (e2) => function __PRIVATE_localStoreGetTargetData(e3, t2, n2) {
    const r3 = __PRIVATE_debugCast(e3), i2 = r3.Xi.get(n2);
    return void 0 !== i2 ? PersistencePromise.resolve(r3.Zi.get(i2)) : r3.Qr.getTargetData(t2, n2);
  ...
  }).next(() => r2.Yi.getDocumentsMatchingQuery(e2, t, n ? i : SnapshotVersion.min(), n ? s : __PRIVATE_documentKeySet())).next((e3) => (__PRIVATE_setMaxReadTime(r2, __PRIVATE_queryCollectionGroup(t), e3), {
    documents: e3,
    _s: s
  })));
}
function __PRIVATE_localStoreGetCachedTarget(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = __PRIVATE_debugCast(n.Qr), i = n.Zi.get(t);
...
function __PRIVATE_localStoreGetNewDocumentChanges(e, t) {
  ...
  return n.persistence.runTransaction("Get new document changes", "readonly", (e2) => n.ts.getAllFromCollectionGroup(
    e2,
    t,
...
async function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, r2) {
  ...
  for (const e2 of n) {
    ...
    const r3 = t.cs(e2);
    r3.setReadTime(t.ls(e2.metadata.readTime)), o = o.insert(n2, r3);
  }
  ...
  return i.persistence.runTransaction("Apply bundle documents", "readwrite", (e2) => __PRIVATE_populateDocumentChangeBuffer(e2, _, o).next((t2) => (_.apply(e2), t2)).next((t2) => i.Qr.removeMatchingKeysForTargetId(e2, a.targetId).next(() => i.Qr.addMatchingKeys(e2, s, a.targetId)).next(() => i.localDocuments.getLocalViewOfDocuments(e2, t2.ss, t2.os)).next(() => t2.ss)));
}
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
  ...
  return i.persistence.runTransaction("Save named query", "readwrite", (e2) => {
    ...
    return i.Zi = i.Zi.insert(o.targetId, o), i.Qr.updateTargetData(e2, o).next(() => i.Qr.removeMatchingKeysForTargetId(e2, r2.targetId)).next(() => i.Qr.addMatchingKeys(e2, n, r2.targetId)).next(() => i.$r.saveNamedQuery(e2, t));
  });
}
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r2, i) {
    this.window = e, this.oi = t, this.persistenceKey = n, this.Es = r2, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.ds = this.As.bind(this), this.Rs = new SortedMap(__PRIVATE_primitiveComparator), this.started = false, /**
     * Captures WebStorage events that occur before `start()` is called. These
     * events are replayed once `WebStorageSharedClientState` is started.
     */
    this.Vs = [];
    const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.fs = createWebStorageClientStateKey(this.persistenceKey, this.Es), this.gs = /** Assembles the key for the current sequence number. */
    function createWebStorageSequenceNumberKey(e2) {
      return `firestore_sequence_number_${e2}`;
    }(this.persistenceKey), this.Rs = this.Rs.insert(this.Es, new __PRIVATE_LocalClientState()), this.ps = new RegExp(`^firestore_clients_${s}_([^_]*)$`), this.ys = new RegExp(`^firestore_mutations_${s}_(\\d+)(?:_(.*))?$`), this.ws = new RegExp(`^firestore_targets_${s}_(\\d+)$`), this.Ss = /** Assembles the key for the online state of the primary tab. */
  ...
  async start() {
    ...
    for (const t2 of e) {
      ...
      if (e2) {
        const n = __PRIVATE_RemoteClientState.hs(t2, e2);
  ...
  updateMutationState(e, t, n) {
    this.Ms(e, t, n), // Once a final mutation result is observed by other clients, they no longer
  ...
  addLocalQueryTarget(e) {
    ...
    if (this.isActiveQueryTarget(e)) {
      ...
      if (n) {
        const r2 = __PRIVATE_QueryTargetMetadata.hs(e, n);
        r2 && (t = r2.state);
      }
    }
  ...
  shutdown() {
    this.started && (this.window.removeEventListener("storage", this.ds), this.removeItem(this.fs), this.started = false);
  }
  getItem(e) {
  ...
  As(e) {
    ...
    if (t.storageArea === this.storage) {
      if (__PRIVATE_logDebug("SharedClientState", "EVENT", t.key, t.newValue), t.key === this.fs)
      ...
      this.oi.enqueueRetryable(async () => {
        if (this.started) {
          if (null !== t.key) {
            if (this.ps.test(t.key)) {
              if (null == t.newValue) {
                const e2 = this.ks(t.key);
                return this.qs(e2, null);
              }
              {
                const e2 = this.Qs(t.key, t.newValue);
                if (e2)
                  return this.qs(e2.clientId, e2);
              }
   ...
   */
  Ks(e, t) {
    const n = this.ys.exec(e), r2 = Number(n[1]), i = void 0 !== n[2] ? n[2] : null;
    return __PRIVATE_MutationMetadata.hs(new User(i), r2, t);
  }
  /**
   ...
   */
  Us(e, t) {
    const n = this.ws.exec(e), r2 = Number(n[1]);
    return __PRIVATE_QueryTargetMetadata.hs(r2, t);
  }
  /**
  ...
  async $s(e) {
    if (e.user.uid === this.currentUser.uid)
      return this.syncEngine.js(e.batchId, e.state, e.error);
  ...
  qs(e, t) {
    const n = t ? this.Rs.insert(e, t) : this.Rs.remove(e), r2 = this.Fs(this.Rs), i = this.Fs(n), s = [], o = [];
    return i.forEach((e2) => {
      r2.has(e2) || s.push(e2);
    }), r2.forEach((e2) => {
      i.has(e2) || o.push(e2);
...
var __PRIVATE_MemorySharedClientState = class {
  constructor() {
    this.Ys = new __PRIVATE_LocalClientState(), this.Zs = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
  }
  addPendingMutation(e) {
  }
  updateMutationState(e, t, n) {
...
class __PRIVATE_RestConnection {
  constructor(e) {
    ...
    this.Ao = t + "://" + e.host, this.Ro = `projects/${n}/databases/${r2}`, this.Vo = "(default)" === this.databaseId.database ? `project_id=${n}` : `project_id=${n}&database_id=${r2}`;
  }
  get mo() {
    return false;
  }
  fo(e, t, n, r2, i) {
    ...
    return this.yo(_, r2, i), this.wo(e, o, _, n).then((t2) => (__PRIVATE_logDebug("RestConnection", `Received RPC '${e}' ${s}: `, t2), t2), (t2) => {
      throw __PRIVATE_logWarn("RestConnection", `RPC '${e}' ${s} failed with error: `, t2, "url: ", o, "request:", n), t2;
    });
  }
  So(e, t, n, r2, i, s) {
    return this.fo(e, t, n, r2, i);
  }
  /**
  ...
  bo(e, t, n) {
    const r2 = __PRIVATE_generateUniqueDebugId(), i = [this.Ao, "/", "google.firestore.v1.Firestore", "/", e, "/channel"], s = createWebChannelTransport(), o = getStatEventTarget(), _ = {
    ...
    void 0 !== a && (_.longPollingTimeout = Math.round(1e3 * a)), this.useFetchStreams && (_.useFetchStreams = true), this.yo(_.initMessageHeaders, t, n), // Sending the custom headers we just added to request.initMessageHeaders
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      h || (h = true, __PRIVATE_logDebug(Ve, `RPC '${e}' stream ${r2} transport closed`), P2.To());
    }), __PRIVATE_unguardedEventListen(c, WebChannel.EventType.ERROR, (t2) => {
      h || (h = true, __PRIVATE_logWarn(Ve, `RPC '${e}' stream ${r2} transport errored:`, t2), P2.To(new FirestoreError(D2.UNAVAILABLE, "The operation could not be completed")));
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          h = true, P2.To(new FirestoreError(n3, i3)), c.close();
        } else
          __PRIVATE_logDebug(Ve, `RPC '${e}' stream ${r2} received:`, i2), P2.Eo(i2);
      }
...
var __PRIVATE_ExponentialBackoff = class {
  constructor(e, t, n = 1e3, r2 = 1.5, i = 6e4) {
    this.oi = e, this.timerId = t, this.Do = n, this.vo = r2, this.Co = i, this.Fo = 0, this.Mo = null, /** The last backoff attempt, as epoch milliseconds. */
  ...
  No(e) {
    this.cancel();
    const t = Math.floor(this.Fo + this.Bo()), n = Math.max(0, Date.now() - this.xo), r2 = Math.max(0, t - n);
    r2 > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${r2} ms (base delay: ${this.Fo} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`), this.Mo = this.oi.enqueueAfterDelay(this.timerId, r2, () => (this.xo = Date.now(), e())), // Apply backoff factor to determine next delay and ensure it is within
    // bounds.
  ...
  Bo() {
    return (Math.random() - 0.5) * this.Fo;
  }
};
var __PRIVATE_PersistentStream = class {
  constructor(e, t, n, r2, i, s, o, _) {
    this.oi = e, this.ko = n, this.qo = r2, this.connection = i, this.authCredentialsProvider = s, this.appCheckCredentialsProvider = o, this.listener = _, this.state = 0, /**
   ...
   */
  Wo() {
    return 1 === this.state || 5 === this.state || this.Go();
  }
  /**
   ...
   */
  async close(e, t) {
    this.Zo(), this.Xo(), this.Uo.cancel(), // Invalidates any stream-related callbacks (e.g. from auth or the
    ...
    this.Qo++, 4 !== e ? (
      ...
      (__PRIVATE_logError(t.toString()), __PRIVATE_logError("Using maximum backoff delay to prevent overloading the backend."), this.Uo.Oo())
    ...
    null !== this.stream && (this.e_(), this.stream.close(), this.stream = null), // This state must be assigned before calling onClose() to allow the callback to
  ...
  n_(e, t) {
    ...
    this.stream = this.i_(e, t), this.stream.uo(() => {
      n(() => (this.state = 2, this.$o = this.oi.enqueueAfterDelay(this.qo, 1e4, () => (this.Go() && (this.state = 3), Promise.resolve())), this.listener.uo()));
    }), this.stream.lo((e2) => {
      n(() => this.r_(e2));
  ...
  t_(e) {
    return (t) => {
      this.oi.enqueueAndForget(() => this.Qo === e ? t() : (__PRIVATE_logDebug("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), Promise.resolve()));
    };
  }
};
var __PRIVATE_PersistentListenStream = class extends __PRIVATE_PersistentStream {
  ...
  __(e) {
    const t = {};
    t.database = __PRIVATE_getEncodedDatabaseId(this.serializer), t.removeTarget = e, this.Yo(t);
  }
};
var __PRIVATE_PersistentWriteStream = class extends __PRIVATE_PersistentStream {
  constructor(e, t, n, r2, i, s) {
    super(e, "write_stream_connection_backoff", "write_stream_idle", "health_check_timeout", t, n, r2, s), this.serializer = i, this.a_ = false;
  }
  /**
  ...
  start() {
    this.a_ = false, this.lastStreamToken = void 0, super.start();
  }
  e_() {
    this.a_ && this.c_([]);
  }
  ...
  onMessage(e) {
    ...
    return __PRIVATE_hardAssert(!e.writeResults || 0 === e.writeResults.length), this.a_ = true, this.listener.h_();
  }
  /**
...
var __PRIVATE_DatastoreImpl = class extends class Datastore {
  ...
  constructor(e, t, n, r2) {
    super(), this.authCredentials = e, this.appCheckCredentials = t, this.connection = n, this.serializer = r2, this.I_ = false;
  }
  T_() {
    if (this.I_)
  ...
  fo(e, t, n) {
    return this.T_(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([r2, i]) => this.connection.fo(e, t, n, r2, i)).catch((e2) => {
  ...
  So(e, t, n, r2) {
    return this.T_(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([i, s]) => this.connection.So(e, t, n, i, s, r2)).catch((e2) => {
      throw "FirebaseError" === e2.name ? (e2.code === D2.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), e2) : new FirestoreError(D2.UNKNOWN, e2.toString());
    });
  }
  terminate() {
...
async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
  var r2;
  const i = __PRIVATE_debugCast(e), { request: s, E_: o } = function __PRIVATE_toRunAggregationQueryRequest(e2, t2, n2) {
    ...
    (t2.Te = __PRIVATE__queryToTarget(t2, e2.explicitOrderBy)), t2.Te;
  }(t), n), _ = s.parent;
...
var __PRIVATE_OnlineStateTracker = class {
  ...
  V_() {
    0 === this.d_ && (this.m_(
      "Unknown"
      /* OnlineState.Unknown */
    ), this.A_ = this.asyncQueue.enqueueAfterDelay("online_state_timeout", 1e4, () => (this.A_ = null, this.f_("Backend didn't respond within 10 seconds."), this.m_(
      "Offline"
      /* OnlineState.Offline */
    ), Promise.resolve())));
  }
  ...
  g_(e) {
    "Online" === this.state ? this.m_(
      "Unknown"
      /* OnlineState.Unknown */
    ) : (this.d_++, this.d_ >= 1 && (this.p_(), this.f_(`Connection failed 1 times. Most recent error: ${e.toString()}`), this.m_(
      "Offline"
      /* OnlineState.Offline */
    )));
  }
   ...
   */
  set(e) {
    this.p_(), this.d_ = 0, "Online" === e && // We've connected to watch at least once. Don't warn the developer
    // about being offline going forward.
    (this.R_ = false), this.m_(e);
  }
  m_(e) {
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;
    this.R_ ? (__PRIVATE_logError(t), this.R_ = false) : __PRIVATE_logDebug("OnlineStateTracker", t);
  }
  p_() {
...
var __PRIVATE_RemoteStoreImpl = class {
  constructor(e, t, n, r2, i) {
     ...
     */
    this.w_ = /* @__PURE__ */ new Map(), /**
     * A set of reasons for why the RemoteStore may be offline. If empty, the
     * RemoteStore may start its network connections.
     */
    this.S_ = /* @__PURE__ */ new Set(), /**
     ...
     */
    this.b_ = [], this.D_ = i, this.D_.Xs((e2) => {
      n.enqueueAndForget(async () => {
        __PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug("RemoteStore", "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e3) {
          ...
          ), await __PRIVATE_disableNetworkInternal(t2), t2.v_.set(
            "Unknown"
            /* OnlineState.Unknown */
          ), t2.S_.delete(
            4
    ...
    }), this.v_ = new __PRIVATE_OnlineStateTracker(n, r2);
  }
};
...
function __PRIVATE_remoteStoreListen(e, t) {
  const n = __PRIVATE_debugCast(e);
  n.w_.has(t.targetId) || // Mark this as something the client is currently listening for.
  (n.w_.set(t.targetId, t), __PRIVATE_shouldStartWatchStream(n) ? (
    // The listen will be sent in onWatchStreamOpen
    __PRIVATE_startWatchStream(n)
  ) : __PRIVATE_ensureWatchStream(n).Go() && __PRIVATE_sendWatchRequest(n, t));
}
function __PRIVATE_remoteStoreUnlisten(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = __PRIVATE_ensureWatchStream(n);
  n.w_.delete(t), r2.Go() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.w_.size && (r2.Go() ? r2.Ho() : __PRIVATE_canUseNetwork(n) && // Revert to OnlineState.Unknown if the watch stream is not open and we
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
    ...
    try {
      ...
      async function __PRIVATE_handleTargetError(e2, t2) {
        ...
        for (const r2 of t2.targetIds)
          e2.w_.has(r2) && (await e2.remoteSyncer.rejectListen(r2, n2), e2.w_.delete(r2), e2.C_.removeTarget(r2));
      }(e, t);
    } catch (n2) {
  ...
  else if (t instanceof __PRIVATE_DocumentWatchChange ? e.C_.Ge(t) : t instanceof __PRIVATE_ExistenceFilterChange ? e.C_.Xe(t) : e.C_.He(t), !n.isEqual(SnapshotVersion.min()))
    try {
      ...
      */
      function __PRIVATE_raiseWatchSnapshot(e2, t3) {
        const n2 = e2.C_._t(t3);
        return n2.targetChanges.forEach((n3, r2) => {
          if (n3.resumeToken.approximateByteSize() > 0) {
            const i = e2.w_.get(r2);
            i && e2.w_.set(r2, i.withResumeToken(n3.resumeToken, t3));
          }
        }), // Re-establish listens for the targets that have been invalidated by
        // existence filter mismatches.
        n2.targetMismatches.forEach((t4, n3) => {
          const r2 = e2.w_.get(t4);
          if (!r2)
            return;
          e2.w_.set(t4, r2.withResumeToken(ByteString.EMPTY_BYTE_STRING, r2.snapshotVersion)), // Cause a hard reset by unwatching and rewatching immediately, but
...
async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  ...
  await __PRIVATE_disableNetworkInternal(e), e.v_.set(
    "Offline"
    /* OnlineState.Offline */
  ...
  e.asyncQueue.enqueueRetryable(async () => {
    __PRIVATE_logDebug("RemoteStore", "Retrying IndexedDB access"), await n(), e.S_.delete(
      1
      /* OfflineCause.IndexedDbFailed */
...
async function __PRIVATE_fillWritePipeline(e) {
  ...
  let r2 = t.y_.length > 0 ? t.y_[t.y_.length - 1].batchId : -1;
...
async function __PRIVATE_onMutationResult(e, t, n) {
  const r2 = e.y_.shift(), i = MutationBatchResult.from(r2, t, n);
...
async function __PRIVATE_onWriteStreamClose(e, t) {
  t && __PRIVATE_ensureWriteStream(e).u_ && // This error affects the actual write.
  await async function __PRIVATE_handleWriteError(e2, t2) {
    if (function __PRIVATE_isPermanentWriteError(e3) {
      ...
      const n = e2.y_.shift();
      __PRIVATE_ensureWriteStream(e2).jo(), await __PRIVATE_executeWithRecovery(e2, () => e2.remoteSyncer.rejectFailedWrite(n.batchId, t2)), // It's possible that with the completion of this mutation
...
async function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
  ...
  n.v_.set(
    "Unknown"
    /* OnlineState.Unknown */
  ), await n.remoteSyncer.handleCredentialChange(t), n.S_.delete(
    3
    /* OfflineCause.CredentialChange */
...
async function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
  ...
  ), await __PRIVATE_enableNetworkInternal(n)) : t || (n.S_.add(
    2
    /* OfflineCause.IsSecondary */
  ), await __PRIVATE_disableNetworkInternal(n), n.v_.set(
    "Unknown"
    /* OnlineState.Unknown */
  ));
}
function __PRIVATE_ensureWatchStream(e) {
  return e.F_ || // Create stream (but note that it is not started yet).
  (e.F_ = function __PRIVATE_newPersistentWatchStream(e2, t, n) {
    const r2 = __PRIVATE_debugCast(e2);
    return r2.T_(), new __PRIVATE_PersistentListenStream(t, r2.connection, r2.authCredentials, r2.appCheckCredentials, r2.serializer, n);
    ...
    t ? (e.F_.jo(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.v_.set(
      "Unknown"
      /* OnlineState.Unknown */
    )) : (await e.F_.stop(), __PRIVATE_cleanUpWatchStreamState(e));
  })), e.F_;
}
function __PRIVATE_ensureWriteStream(e) {
  return e.M_ || // Create stream (but note that it is not started yet).
  (e.M_ = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    const r2 = __PRIVATE_debugCast(e2);
    return r2.T_(), new __PRIVATE_PersistentWriteStream(t, r2.connection, r2.authCredentials, r2.appCheckCredentials, r2.serializer, n);
  }(e.datastore, e.asyncQueue, {
    ...
    t ? (e.M_.jo(), // This will start the write stream if necessary.
    await __PRIVATE_fillWritePipeline(e)) : (await e.M_.stop(), e.y_.length > 0 && (__PRIVATE_logDebug("RemoteStore", `Stopping write stream with ${e.y_.length} pending writes`), e.y_ = []));
  })), e.M_;
}
...
var __PRIVATE_DocumentChangeSet = class {
  ...
  track(e) {
    ...
    n ? (
      ...
      0 !== e.type && 3 === n.type ? this.x_ = this.x_.insert(t, e) : 3 === e.type && 1 !== n.type ? this.x_ = this.x_.insert(t, {
        type: n.type,
        doc: e.doc
      }) : 2 === e.type && 2 === n.type ? this.x_ = this.x_.insert(t, {
        type: 2,
        doc: e.doc
      }) : 2 === e.type && 0 === n.type ? this.x_ = this.x_.insert(t, {
        type: 0,
        doc: e.doc
      }) : 1 === e.type && 0 === n.type ? this.x_ = this.x_.remove(t) : 1 === e.type && 2 === n.type ? this.x_ = this.x_.insert(t, {
        type: 1,
        doc: n.doc
      }) : 0 === e.type && 1 === n.type ? this.x_ = this.x_.insert(t, {
        type: 2,
        doc: e.doc
      }) : (
...
var __PRIVATE_EventManagerImpl = class {
  constructor() {
    this.queries = new ObjectMap((e) => __PRIVATE_canonifyQuery(e), __PRIVATE_queryEquals), this.onlineState = "Unknown", this.B_ = /* @__PURE__ */ new Set();
  }
};
...
var __PRIVATE_QueryListener = class {
  constructor(e, t, n) {
     ...
     */
    this.Q_ = false, this.K_ = null, this.onlineState = "Unknown", this.options = n || {};
  }
  /**
  ...
  k_(e) {
    ...
    let t = false;
    return this.Q_ ? this.U_(e) && (this.q_.next(e), t = true) : this.W_(e, this.onlineState) && (this.G_(e), t = true), this.K_ = e, t;
  }
  onError(e) {
    this.q_.error(e);
  }
  ...
  L_(e) {
    this.onlineState = e;
    let t = false;
    return this.K_ && !this.Q_ && this.W_(this.K_, e) && (this.G_(this.K_), t = true), t;
  }
  W_(e, t) {
    if (!e.fromCache)
      return true;
  ...
  G_(e) {
    e = ViewSnapshot.fromInitialDocuments(e.query, e.docs, e.mutatedKeys, e.fromCache, e.hasCachedResults), this.Q_ = true, this.q_.next(e);
  }
};
...
var __PRIVATE_BundleConverterImpl = class {
   ...
   */
  cs(e) {
    return e.metadata.exists ? __PRIVATE_fromDocument(this.serializer, e.document, false) : MutableDocument.newNoDocument(this.us(e.metadata.name), this.ls(e.metadata.readTime));
  }
  ls(e) {
...
var __PRIVATE_BundleLoader = class {
  ...
  Y_(e) {
    ...
    if (e.j_.namedQuery)
      this.queries.push(e.j_.namedQuery);
    else if (e.j_.documentMetadata) {
      this.documents.push({
      ...
      e.j_.document && (this.documents[this.documents.length - 1].document = e.j_.document, ++t);
  ...
  Z_(e) {
    ...
    for (const r2 of e)
      if (r2.metadata.queries) {
        const e2 = n.us(r2.metadata.name);
...
var __PRIVATE_View = class {
  constructor(e, t) {
    this.query = e, this.ta = t, this.na = null, this.hasCachedResults = false, /**
    ...
    this.mutatedKeys = __PRIVATE_documentKeySet(), this.ia = __PRIVATE_newQueryComparator(e), this.sa = new DocumentSet(this.ia);
  }
  /**
   ...
   */
  _a(e, t) {
    const n = t ? t.aa : new __PRIVATE_DocumentChangeSet(), r2 = t ? t.sa : this.sa;
  ...
  applyChanges(e, t, n) {
    ...
    }(e2.type, t2.type) || this.ia(e2.doc, t2.doc)), this.ca(n);
    const s = t ? this.la() : [], o = 0 === this.ra.size && this.current ? 1 : 0, _ = o !== this.na;
  ...
  la() {
    if (!this.current)
      return [];
    const e = this.ra;
    this.ra = __PRIVATE_documentKeySet(), this.sa.forEach((e2) => {
      this.Pa(e2.key) && (this.ra = this.ra.add(e2.key));
    });
    const t = [];
    return e.forEach((e2) => {
  ...
  // PORTING NOTE: Multi-tab only.
  Ta() {
    return ViewSnapshot.fromInitialDocuments(this.query, this.sa, this.mutatedKeys, 0 === this.na, this.hasCachedResults);
  }
};
...
var __PRIVATE_SyncEngineImpl = class {
  constructor(e, t, n, r2, i, s) {
    this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r2, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.da = {}, this.Aa = new ObjectMap((e2) => __PRIVATE_canonifyQuery(e2), __PRIVATE_queryEquals), this.Ra = /* @__PURE__ */ new Map(), /**
     ...
     */
    this.fa = /* @__PURE__ */ new Map(), this.ga = new __PRIVATE_ReferenceSet(), /** Stores user completion handlers, indexed by User and BatchId. */
    this.pa = {}, /** Stores user callbacks waiting for all pending writes to be acknowledged. */
    this.ya = /* @__PURE__ */ new Map(), this.wa = __PRIVATE_TargetIdGenerator.Bn(), this.onlineState = "Unknown", // The primary state is set to `true` or `false` immediately after Firestore
...
async function __PRIVATE_syncEngineListen(e, t) {
  ...
  const s = n.Aa.get(t);
  if (s)
    r2 = s.targetId, n.sharedClientState.addLocalQueryTarget(r2), i = s.view.Ta();
  else {
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r2, i) {
  e.ba = (t2, n2, r3) => async function __PRIVATE_applyDocChanges(e2, t3, n3, r4) {
    let i2 = t3.view._a(n3);
    i2.Hi && // The query has a limit and some docs were removed, so we need
    ...
    (i2 = await __PRIVATE_localStoreExecuteQuery(
      ...
      /* usePreviousResults= */
      false
    ).then(({ documents: e3 }) => t3.view._a(e3, i2)));
    ...
    return __PRIVATE_updateTrackedLimbos(e2, t3.targetId, o2.ha), o2.snapshot;
  }(e, t2, n2, r3);
  const s = await __PRIVATE_localStoreExecuteQuery(
    ...
    /* usePreviousResults= */
    true
  ), o = new __PRIVATE_View(t, s._s), _ = o._a(s.documents), a = TargetChange.createSynthesizedTargetChangeForCurrentChange(n, r2 && "Offline" !== e.onlineState, i), u = o.applyChanges(
    _,
    /* updateLimboDocuments= */
    e.isPrimaryClient,
    a
...
async function __PRIVATE_syncEngineUnlisten(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = n.Aa.get(t), i = n.Ra.get(r2.targetId);
  if (i.length > 1)
    return n.Ra.set(r2.targetId, i.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void n.Aa.delete(t);
  ...
  try {
    const e2 = await function __PRIVATE_localStoreWriteLocally(e3, t2) {
      ...
      return n2.persistence.runTransaction("Locally write mutations", "readwrite", (e4) => {
        let _ = __PRIVATE_mutableDocumentMap(), a = __PRIVATE_documentKeySet();
        return n2.ts.getEntries(e4, i).next((e5) => {
    ...
    r2.sharedClientState.addPendingMutation(e2.batchId), function __PRIVATE_addMutationCallback(e3, t2, n2) {
      let r3 = e3.pa[e3.currentUser.toKey()];
      r3 || (r3 = new SortedMap(__PRIVATE_primitiveComparator));
      r3 = r3.insert(t2, n2), e3.pa[e3.currentUser.toKey()] = r3;
...
async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
  ...
  try {
    ...
    t.targetChanges.forEach((e3, t2) => {
      ...
      (__PRIVATE_hardAssert(e3.addedDocuments.size + e3.modifiedDocuments.size + e3.removedDocuments.size <= 1), e3.addedDocuments.size > 0 ? r2.Ea = true : e3.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(r2.Ea) : e3.removedDocuments.size > 0 && (__PRIVATE_hardAssert(r2.Ea), r2.Ea = false));
...
function __PRIVATE_syncEngineApplyOnlineStateChange(e, t, n) {
  ...
  if (r2.isPrimaryClient && 0 === n || !r2.isPrimaryClient && 1 === n) {
    ...
    }(r2.eventManager, t), e2.length && r2.da.s_(e2), r2.onlineState = t, r2.isPrimaryClient && r2.sharedClientState.setOnlineState(t);
  }
}
async function __PRIVATE_syncEngineRejectListen(e, t, n) {
  ...
  if (s) {
    ...
    r2.ma = r2.ma.remove(s), r2.fa.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r2);
  } else
...
async function __PRIVATE_syncEngineRegisterPendingWritesCallback(e, t) {
  ...
  try {
    ...
    const r2 = n.ya.get(e2) || [];
    r2.push(t), n.ya.set(e2, r2);
  } catch (e2) {
...
function __PRIVATE_triggerPendingWritesCallbacks(e, t) {
  (e.ya.get(t) || []).forEach((e2) => {
    e2.resolve();
  }), e.ya.delete(t);
}
function __PRIVATE_processUserCallback(e, t, n) {
  const r2 = __PRIVATE_debugCast(e);
  let i = r2.pa[r2.currentUser.toKey()];
  if (i) {
    const e2 = i.get(t);
    e2 && (n ? e2.reject(n) : e2.resolve(), i = i.remove(t)), r2.pa[r2.currentUser.toKey()] = i;
  }
}
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  e.sharedClientState.removeLocalQueryTarget(t);
  for (const r2 of e.Ra.get(t))
    e.Aa.delete(r2), n && e.da.Da(r2, n);
  if (e.Ra.delete(t), e.isPrimaryClient) {
    e.ga.Vr(t).forEach((t2) => {
      e.ga.containsKey(t2) || // We removed the last reference for this key
...
function __PRIVATE_removeLimboTarget(e, t) {
  ...
  const n = e.ma.get(t);
  null !== n && (__PRIVATE_remoteStoreUnlisten(e.remoteStore, n), e.ma = e.ma.remove(t), e.fa.delete(n), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r2 of n)
    if (r2 instanceof __PRIVATE_AddedLimboDocument)
      e.ga.addReference(r2.key, t), __PRIVATE_trackLimboChange(e, r2);
    else if (r2 instanceof __PRIVATE_RemovedLimboDocument) {
      __PRIVATE_logDebug("SyncEngine", "Document no longer in limbo: " + r2.key), e.ga.removeReference(r2.key, t);
      e.ga.containsKey(r2.key) || // We removed the last reference for this key
...
function __PRIVATE_trackLimboChange(e, t) {
  ...
  e.ma.get(n) || e.Va.has(r2) || (__PRIVATE_logDebug("SyncEngine", "New document in limbo: " + n), e.Va.add(r2), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
function __PRIVATE_pumpEnqueuedLimboResolutions(e) {
  for (; e.Va.size > 0 && e.ma.size < e.maxConcurrentLimboResolutions; ) {
    const t = e.Va.values().next().value;
    e.Va.delete(t);
    const n = new DocumentKey(ResourcePath.fromString(t)), r2 = e.wa.next();
    e.fa.set(r2, new LimboResolution(n)), e.ma = e.ma.insert(n, r2), __PRIVATE_remoteStoreListen(e.remoteStore, new TargetData(__PRIVATE_queryToTarget(__PRIVATE_newQueryForPath(n.path)), r2, "TargetPurposeLimboResolution", __PRIVATE_ListenSequence.ae));
  }
}
async function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
  const r2 = __PRIVATE_debugCast(e), i = [], s = [], o = [];
  r2.Aa.isEmpty() || (r2.Aa.forEach((e2, _) => {
  ...
  }), await Promise.all(o), r2.da.s_(i), await async function __PRIVATE_localStoreNotifyLocalViewChanges(e2, t2) {
    ...
    for (const e3 of t2) {
      ...
      if (!e3.fromCache) {
        const e4 = n2.Zi.get(t3), r3 = e4.snapshotVersion, i2 = e4.withLastLimboFreeSnapshotVersion(r3);
        n2.Zi = n2.Zi.insert(t3, i2);
      }
    }
  }(r2.localStore, s));
}
...
function __PRIVATE_syncEngineGetRemoteKeysForTarget(e, t) {
    ...
    return __PRIVATE_documentKeySet().add(r2.key);
  {
    ...
    if (!r3)
      return e2;
    for (const t2 of r3) {
      const r4 = n.Aa.get(t2);
      e2 = e2.unionWith(r4.view.oa);
    }
    return e2;
  }
}
async function __PRIVATE_synchronizeViewAndComputeSnapshot(e, t) {
  ...
  return n.isPrimaryClient && __PRIVATE_updateTrackedLimbos(n, t.targetId, i.ha), i;
}
...
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  const n = __PRIVATE_debugCast(e);
  if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.Sa) {
    ...
    n.Sa = true, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, true);
    for (const e3 of t2)
      __PRIVATE_remoteStoreListen(n.remoteStore, e3);
  } else if (false === t && false !== n.Sa) {
    const e2 = [];
    ...
    function __PRIVATE_resetLimboDocuments(e3) {
      ...
      }), t3.ga.mr(), t3.fa = /* @__PURE__ */ new Map(), t3.ma = new SortedMap(DocumentKey.comparator);
    }(n), n.Sa = false, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
  }
}
async function __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(e, t, n) {
  ...
  for (const e2 of t) {
    let t2;
    const n2 = r2.Ra.get(e2);
    if (n2 && 0 !== n2.length) {
      t2 = await __PRIVATE_localStoreAllocateTarget(r2.localStore, __PRIVATE_queryToTarget(n2[0]));
      for (const e3 of n2) {
        const t3 = r2.Aa.get(e3), n3 = await __PRIVATE_synchronizeViewAndComputeSnapshot(r2, t3);
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r2.Sa) {
    ...
    for (const e2 of n)
      r2.Ra.has(e2) && // Release queries that are still active.
      await __PRIVATE_localStoreReleaseTarget(
        r2.localStore,
        e2,
        /* keepPersistedTargetData */
...
function __PRIVATE_ensureWatchCallbacks(e) {
  const t = __PRIVATE_debugCast(e);
  return t.remoteStore.remoteSyncer.applyRemoteEvent = __PRIVATE_syncEngineApplyRemoteEvent.bind(null, t), t.remoteStore.remoteSyncer.getRemoteKeysForTarget = __PRIVATE_syncEngineGetRemoteKeysForTarget.bind(null, t), t.remoteStore.remoteSyncer.rejectListen = __PRIVATE_syncEngineRejectListen.bind(null, t), t.da.s_ = __PRIVATE_eventManagerOnWatchChange.bind(null, t.eventManager), t.da.Da = __PRIVATE_eventManagerOnWatchError.bind(null, t.eventManager), t;
}
...
function __PRIVATE_syncEngineLoadBundle(e, t, n) {
  ...
  (async function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    try {
      ...
      let s = await t2.va();
      for (; s; ) {
        const e3 = await i.Y_(s);
        e3 && n2._updateProgress(e3), s = await t2.va();
      }
      ...
      }(e2.localStore, r3), n2._completeWith(o.progress), Promise.resolve(o.X_);
    } catch (e3) {
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class extends MemoryOfflineComponentProvider {
  constructor(e, t, n) {
    super(), this.Ca = e, this.cacheSizeBytes = t, this.forceOwnership = n, this.synchronizeTabs = false;
  }
  async initialize(e) {
    await super.initialize(e), await this.Ca.initialize(this, e), // Enqueue writes from a previous session
    await __PRIVATE_syncEngineEnsureWriteCallbacks(this.Ca.syncEngine), await __PRIVATE_fillWritePipeline(this.Ca.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  constructor(e, t) {
    super(
      ...
      /* forceOwnership= */
      false
    ), this.Ca = e, this.cacheSizeBytes = t, this.synchronizeTabs = true;
  }
  async initialize(e) {
    ...
    await this.persistence.fi(async (e2) => {
      await __PRIVATE_syncEngineApplyPrimaryState(this.Ca.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
    });
  }
  createSharedClientState(e) {
...
var OnlineComponentProvider = class {
  ...
  createSyncEngine(e, t) {
    return function __PRIVATE_newSyncEngine(e2, t2, n, r2, i, s, o) {
      ...
      return o && (_.Sa = true), _;
    }(this.localStore, this.remoteStore, this.eventManager, this.sharedClientState, e.initialUser, e.maxConcurrentLimboResolutions, t);
  }
  terminate() {
    return async function __PRIVATE_remoteStoreShutdown(e) {
      const t = __PRIVATE_debugCast(e);
      __PRIVATE_logDebug("RemoteStore", "RemoteStore shutting down."), t.S_.add(
        5
        /* OfflineCause.Shutdown */
      ), await __PRIVATE_disableNetworkInternal(t), t.D_.shutdown(), // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    ...
    this.Na().then((e2) => {
      e2 && e2.H_() ? this.metadata.resolve(e2.j_.metadata) : this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
             ${JSON.stringify(null == e2 ? void 0 : e2.j_)}`));
...
var Transaction$2 = class {
  ...
  async lookup(e) {
    ...
    const t = await async function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
      ...
      }, s = await n.So("BatchGetDocuments", r2, i, t2.length), o = /* @__PURE__ */ new Map();
      s.forEach((e3) => {
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r2, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r2, this.deferred = i, this.Ka = n.maxAttempts, this.Uo = new __PRIVATE_ExponentialBackoff(
      this.asyncQueue,
      "transaction_retry"
  ...
  Wa(e) {
    this.Ka > 0 && this.Ga(e) ? (this.Ka -= 1, this.asyncQueue.enqueueAndForget(() => (this.$a(), Promise.resolve()))) : this.deferred.reject(e);
  }
  Ga(e) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => async function __PRIVATE_executeQueryFromCache(e2, t2, n2) {
    try {
      const r2 = await __PRIVATE_localStoreExecuteQuery(
        ...
        /* usePreviousResults= */
        true
      ), i = new __PRIVATE_View(t2, r2._s), s = i._a(r2.documents), o = i.applyChanges(
        s,
        /* updateLimboDocuments= */
        false
      );
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
    __PRIVATE_debugCast(e2).B_.add(t2), // Immediately fire an initial event, indicating all existing listeners
    // are in-sync.
    t2.next();
  }(await __PRIVATE_getEventManager(e), n)), () => {
    n.Ma(), e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_removeSnapshotsInSyncListener(e2, t2) {
      __PRIVATE_debugCast(e2).B_.delete(t2);
    }(await __PRIVATE_getEventManager(e), n));
  };
}
...
var __PRIVATE_AsyncQueueImpl = class {
  constructor() {
    ...
    this.ja = [], // Is this AsyncQueue being shut down? Once it is set to true, it will not
    // be changed again.
    this.Ha = false, // Operations scheduled to be queued in the future. Operations are
    // automatically removed after they are run or canceled.
    this.Ja = [], // visible for testing
    this.Ya = null, // Flag set while there's an outstanding AsyncQueue operation, used for
    // assertion sanity-checks.
    this.Za = false, // Enabled during shutdown on Safari to prevent future access to IndexedDB.
    this.Xa = false, // List of TimerIds to fast-forward delays for.
    this.eu = [], // Backoff timer used to schedule retries for retryable operations
    this.Uo = new __PRIVATE_ExponentialBackoff(
      this,
      "async_queue_retry"
    ...
    this.tu = () => {
      ...
      e2 && __PRIVATE_logDebug("AsyncQueue", "Visibility state changed to " + e2.visibilityState), this.Uo.Lo();
    };
    const e = getDocument();
  ...
  enqueueAndForgetEvenWhileRestricted(e) {
    this.nu(), // eslint-disable-next-line @typescript-eslint/no-floating-promises
    this.ru(e);
  }
  enterRestrictedMode(e) {
    if (!this.Ha) {
      this.Ha = true, this.Xa = e || false;
      const t = getDocument();
  ...
  enqueue(e) {
    ...
    return this.ru(() => this.Ha && this.Xa ? Promise.resolve() : (e().then(t.resolve, t.reject), t.promise)).then(() => t.promise);
  }
  enqueueRetryable(e) {
  ...
  async iu() {
    if (0 !== this.ja.length) {
      ...
      this.ja.length > 0 && // If there are additional operations, we re-schedule `retryNextOp()`.
  ...
  ru(e) {
    const t = this.za.then(() => (this.Za = true, e().catch((e2) => {
      this.Ya = e2, this.Za = false;
      const t2 = (
        /**
    ...
    }).then((e2) => (this.Za = false, e2))));
    return this.za = t, t;
  }
  enqueueAfterDelay(e, t, n) {
    this.nu(), // Fast-forward delays for timerIds that have been overriden.
...
var __PRIVATE_ParseContextImpl = class ___PRIVATE_ParseContextImpl {
  ...
  Pu(e) {
    var t;
    const n = null === (t = this.path) || void 0 === t ? void 0 : t.child(e), r2 = this.hu({
      path: n,
      Iu: false
    });
    return r2.Tu(e), r2;
  ...
  Au(e) {
    return __PRIVATE_createError(e, this.settings.methodName, this.settings.Ru || false, this.path, this.settings.Vu);
  }
  ...
  cu() {
    if (this.path)
      for (let e = 0; e < this.path.length; e++)
        this.Tu(this.path.get(e));
  }
  Tu(e) {
    if (0 === e.length)
      throw this.Au("Document fields must not be empty");
    if (__PRIVATE_isWrite(this.lu) && ge.test(e))
      throw this.Au('Document fields cannot begin and end with "__"');
  }
};
...
function __PRIVATE_parseSetData(e, t, n, r2, i, s = {}) {
  const o = e.mu(s.merge || s.mergeFields ? 2 : 0, t, n, i);
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.lu)
      throw 1 === e.lu ? e.Au(`${this._methodName}() can only appear at the top level of your update data`) : e.Au(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
var __PRIVATE_ArrayUnionFieldValueImpl = class extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.fu.map((e2) => __PRIVATE_parseData(e2, t)), r2 = new __PRIVATE_ArrayUnionTransformOperation(n);
...
var __PRIVATE_ArrayRemoveFieldValueImpl = class extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.fu.map((e2) => __PRIVATE_parseData(e2, t)), r2 = new __PRIVATE_ArrayRemoveTransformOperation(n);
    return new FieldTransform(e.path, r2);
  }
  isEqual(e) {
    return this === e;
...
function __PRIVATE_parseUpdateVarargs(e, t, n, r2, i, s) {
  const o = e.mu(1, t, n), _ = [__PRIVATE_fieldPathFromArgument$1(t, r2, n)], a = [i];
  if (s.length % 2 != 0)
...
function __PRIVATE_parseQueryValue(e, t, n, r2 = false) {
  return __PRIVATE_parseData(n, e.mu(r2 ? 4 : 3, t));
}
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.lu))
        throw t2.Au(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path)
        throw t2.Au(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  if (
    ...
    if (t.settings.Iu && 4 !== t.lu)
      throw t.Au("Nested arrays are not supported");
    return function __PRIVATE_parseArray(e2, t2) {
      const n = [];
      let r2 = 0;
      for (const i of e2) {
        let e3 = __PRIVATE_parseData(i, t2.du(r2));
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r2.isEqual(n))
        throw t2.Au(`Document reference is for database ${r2.projectId}/${r2.database} but should be for database ${n.projectId}/${n.database}`);
      return {
        referenceValue: __PRIVATE_toResourceName(e2.firestore._databaseId || t2.databaseId, e2._key.path)
      };
    }
    throw t2.Au(`Unsupported field value: ${__PRIVATE_valueDescription(e2)}`);
  }(e, t);
}
...
function __PRIVATE_validatePlainObject(e, t, n) {
  if (!__PRIVATE_looksLikeJsonObject(n) || !function __PRIVATE_isPlainObject(e2) {
    ...
    throw "an object" === r2 ? t.Au(e + " a custom object") : t.Au(e + " " + r2);
  }
}
...
function onSnapshot(e, ...t) {
  ...
  return function __PRIVATE_firestoreClientListen(e2, t2, n2, r3) {
    ...
    return e2.asyncQueue.enqueueAndForget(async () => __PRIVATE_eventManagerListen(await __PRIVATE_getEventManager(e2), s2)), () => {
      i2.Ma(), e2.asyncQueue.enqueueAndForget(async () => __PRIVATE_eventManagerUnlisten(await __PRIVATE_getEventManager(e2), s2));
    };
...
var __PRIVATE_TestingHooksSpiImpl = class ___PRIVATE_TestingHooksSpiImpl {
  ...
  static get instance() {
    return we || (we = new ___PRIVATE_TestingHooksSpiImpl(), function __PRIVATE_setTestingHooksSpi(e) {
      if (ce)
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(w2, "4.1.2", e), // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
  registerVersion(w2, "4.1.2", "esm2017");
}();
export {
